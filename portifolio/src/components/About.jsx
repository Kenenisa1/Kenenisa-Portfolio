  ...
  return (
    <Tilt className="xs:w-[250px] w-full">
      <motion.div
        ...
        className="w-full bg-bottom-right bg-blue-900 p-[1px] rounded-[20px] shadow-card "
      >
        <div
          options={{
            max: 45,
...
const About = () => {
  return (
    <>
      ...
      <div className="mt-20 flex flex-col md:flex-row lg:flex-row xl:flex-row gap-10 ">
